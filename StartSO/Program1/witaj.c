/* 
 ...
 ----------------------------------------------------------------------
 Autor: Wieslaw Placzek,                             Krakow, 29.01.2026
 ----------------------------------------------------------------------
*/ 
...
char *powitanie; // globalny (bo używany w funkcji koniec) wskaznik na teskt powitania
...
int main(void)
{
  ...
  powitanie = malloc(dlpo);            // dynamiczny przydzial pamieci na tekst powitanie
  assert(powitanie && "Blad przydzialu pamieci na stercie!"); // asercja - zglasza blad gdy: powitanie == NULL
